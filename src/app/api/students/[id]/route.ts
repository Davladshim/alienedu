...
export async function PUT(
  ...
  try {
    ...
    await query(
      `UPDATE teacher_students SET lesson_price = $1, family_id = $2, grade = $3, parent_name = $4, call_link = $5, display_name = $6 WHERE id = $7`,
      [
        ...
        display_name !== undefined ? display_name : row.display_name,
        id,
      ]
    )
